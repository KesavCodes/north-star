    ...
    <View className="mt-8">
      ...
      <View className="flex-row space-x-4">
        <TouchableOpacity
          ...
          className="flex-1 bg-[#F0F5FF] rounded-2xl py-3 flex-row items-center justify-center border border-blue-100 mr-2"
        >
        ...
        <TouchableOpacity
          ...
          className="flex-1 bg-[#F5F0FF] rounded-2xl py-3 flex-row items-center justify-center border border-purple-100 ml-2"
        >
