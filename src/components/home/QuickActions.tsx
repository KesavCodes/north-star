    ...
    <View className="mt-3">
      ...
      <View className="flex-row">
        <TouchableOpacity
          ...
          className="flex-1 bg-[#F0F5FF] rounded-2xl py-3.5 flex-row items-center justify-center border border-blue-100 mr-1"
        >
        ...
        <TouchableOpacity
          ...
          className="flex-1 bg-[#F5F0FF] rounded-2xl py-3.5 flex-row items-center justify-center border border-purple-100 ml-1"
        >
