...
import { View, Text, TextInput, TouchableOpacity, ScrollView, SafeAreaView, Platform, StatusBar, KeyboardAvoidingView } from 'react-native';
      ...
      <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'height'} className="flex-1">
        ...
        <View className="flex-row justify-between items-center px-5 mt-4">
          ...
          <View className="items-center">
            <Text className="text-lg font-bold text-slate-800">Daily Reflection</Text>
        ...
        <ScrollView className="flex-1 px-5 mt-6 mb-20" showsVerticalScrollIndicator={false}>
          
          <Text className="text-sm font-semibold text-slate-800 mb-3">Day in Brief</Text>
          <TextInput
            multiline
            value={dayInBrief}
          ...
          />
          <Text className="text-xs text-right text-slate-400 mt-1 mb-6">{dayInBrief.length}/300</Text>

          <Text className="text-sm font-semibold text-slate-800 mb-3">What went well today?</Text>
          <TextInput
            multiline
            value={wentWell}
            ...
            textAlignVertical="top"
          />
          <Text className="text-xs text-right text-slate-400 mt-1 mb-6">{wentWell.length}/300</Text>

          <Text className="text-sm font-semibold text-slate-800 mb-3">What could improve?</Text>
          <TextInput
            multiline
            value={couldImprove}
            ...
            textAlignVertical="top"
          />
          <Text className="text-xs text-right text-slate-400 mt-1 mb-6">{couldImprove.length}/300</Text>

          <Text className="text-sm font-semibold text-slate-800 mb-3">What are you grateful for?</Text>
          <TextInput
            multiline
            value={gratefulFor}
            ...
            textAlignVertical="top"
          />
          <Text className="text-xs text-right text-slate-400 mt-1 mb-8">{gratefulFor.length}/300</Text>
